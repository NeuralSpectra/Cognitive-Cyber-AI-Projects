...
This project predicts the **medical cost of an individual** based on features such as **age, gender, BMI, number of children, smoking status, and region**.

It demonstrates how machine learning can be applied to regression problems using real-world health data, helping to understand which factors influence medical expenses.
